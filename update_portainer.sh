...
sudo docker run -d -p 9000:9000 -p 9443:9443 --dns 10.13.37.250 --network=frontend --name=portainer --restart=always -v /var/run/docker.sock:/var/run/docker.sock -v /container/portainer:/data portainer/portainer-ce:latest || error "Failed to execute newer version of Portainer!"
